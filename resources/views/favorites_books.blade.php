...
<section style="display: flex; flex-wrap:wrap ;text-align: left; height: 100vh;background-image: url(https://images.adsttc.com/media/images/5f17/67a5/b357/65a5/ed00/0076/large_jpg/Luuk_Kramer_study_library_19260-101.jpg?1595369364)">
    @foreach($books as $book)
        <div class="container row align-items-start" style="height: 18rem; width:calc( ( 100% - 40px ) / 8 );">

            <div style="width: max-content; height: 20rem; display: flex; ">

                <div style="display: flex; flex-direction: column;">


                    <form action="{{route('onLineLibraryAddToFavoritePersonal', $book)}}" method = "Post"  style="margin-bottom: 5px ; margin-top: 10px">
                        @csrf
